                                                                            ...
                                                                            <tr>
                                                                                <td width="415" class="es-m-p0r esd-container-frame" valign="top" align="center">
                                                                                    <table cellpadding="0" cellspacing="0" width="100%">
                                                                                        <tbody>
                                                                                            <tr>
                                                                                                <td align="left" class="esd-block-image" style="font-size: 0px;"><a target="_blank" href="https://smartnest-pf.netlify.app/"><img src="https://res.cloudinary.com/dg1roy34p/image/upload/v1674828268/SmartNest/logo_smart_b_xxdxi8.png" alt="Logo" style="display: block; font-size: 12px;" title="Logo" height="72"></a></td>
                                                                                            </tr>
                                                                                        </tbody>
                                                                                    </table>
                                                                                </td>
                                                                                            ...
                                                                                            <table cellpadding="0" cellspacing="0" width="100%" class="es-menu">
                                                                                                <tbody>
                                                                                                    <tr class="links-images-left">
                                                                                                        <td align="center" valign="top" width="33.33%" class="es-p10t es-p10b es-p5r es-p5l"><a target="_blank" style="color: #a0937d"><img src="https://tlr.stripocdn.email/content/guids/CABINET_455a2507bd277c27cf7436f66c6b427c/images/58991620296762845.png" alt="FREE DELIVERY" title="FREE DELIVERY" align="absmiddle" class="es-p15r" width="25"><p style="color: #a0937d;">FREE DELIVERY</p></a></td>
                                                                                                        <td align="center" valign="top" width="33.33%" class="es-p10t es-p10b es-p5r es-p5l" style="border-left: 1px solid #a0937d;"><a target="_blank" style="color: #a0937d;"><img src="https://tlr.stripocdn.email/content/guids/CABINET_455a2507bd277c27cf7436f66c6b427c/images/55781620296763104.png" alt="HIGH QUALITY" title="HIGH QUALITY" align="absmiddle" class="es-p15r" width="25"><p style="color: #a0937d;">HIGH QUALITY</p></a></td>
                                                                                                        <td align="center" valign="top" width="33.33%" class="es-p10t es-p10b es-p5r es-p5l" style="border-left: 1px solid #a0937d;"><a target="_blank" style="color: #a0937d;"><img src="https://tlr.stripocdn.email/content/guids/CABINET_455a2507bd277c27cf7436f66c6b427c/images/88291620296763036.png" alt="BEST CHOICE" title="BEST CHOICE" align="absmiddle" class="es-p15r" width="25"><p style="color: #a0937d;">BEST CHOICE</p></a></td>
                                                                                                    </tr>
                                                                                                </tbody>
                                                                                            </table>
                                                                                        </td>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td class="esd-block-menu" esd-tmp-menu-padding="10|10" esd-tmp-menu-color="#666666" esd-tmp-divider="0|solid|#a0937d">
                                                                                            <table cellpadding="0" cellspacing="0" width="100%" class="es-menu">
                                                                                                <tbody>
                                                                                                    <tr class="links">
                                                                                                        <td align="center" valign="top" width="25%" class="es-p10t es-p10b es-p5r es-p5l" style="padding-bottom: 10px;"><a target="_blank" style="color: #666666;" href="https://smartnest-pf.netlify.app/about" >About us</a></td>
                                                                                                        <td align="center" valign="top" width="25%" class="es-p10t es-p10b es-p5r es-p5l" style="padding-bottom: 10px;"><a target="_blank" style="color: #666666;" href="https://smartnest-pf.netlify.app/news" >News</a></td>
                                                                                                        <td align="center" valign="top" width="25%" class="es-p10t es-p10b es-p5r es-p5l" style="padding-bottom: 10px;"><a target="_blank" style="color: #666666;" href="https://smartnest-pf.netlify.app/foro" >Forum</a></td>
                                                                                                        <td align="center" valign="top" width="25%" class="es-p10t es-p10b es-p5r es-p5l" style="padding-bottom: 10px;"><a target="_blank" style="color: #666666;" href="https://smartnest-pf.netlify.app/shop">The shops</a></td>
                                                                                                    </tr>
                                                                                                </tbody>
                                                                                            </table>
                                                                                        </td>
