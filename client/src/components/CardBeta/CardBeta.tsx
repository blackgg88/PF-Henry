...
import { Categories } from "../../Redux/slice/product/product.slice";
...
const CardBeta: React.FC<{}> = () => {
  ...
  const SRT = useAppSelector((state) => state.productReducer.Filters.order);
  ...
  //console.log("GGa", SRT, Allproduct);
  //console.log("GGa", SRT, Allproduct[20].brand);
  //  Allproduct.sort((a, b) => {
