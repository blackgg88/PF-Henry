    ...
    <div className='navbar_container'>
      ...
      */}
          ...
          <img  className="logo" src={cart} alt='cart' width={20} />
            <NavLink className="link-style" to='/'><p>Home</p></NavLink>
            <NavLink className="link-style" to='/shop'><p>Shop</p></NavLink>
            <NavLink className="link-style" to='/test'><p>Test</p></NavLink>
