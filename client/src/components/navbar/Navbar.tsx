    ...
    <div className="Nav_topLanding">
      ...
      </div>
      {
        responsiveMenu
          ...
          <NavLink onClick={()=> setResponsiveMenu(!responsiveMenu)} className="link-style" to="/shop">
            <p className="nav_middle_button">Shop</p>
          </NavLink>
          <NavLink onClick={()=> setResponsiveMenu(!responsiveMenu)} className="link-style" to="/test">
            <p className="nav_middle_button">Test</p>
          </NavLink>
          <NavLink onClick={()=> setResponsiveMenu(!responsiveMenu)} className="link-style" to="/news">
            <p>News</p>
          </NavLink>
          <NavLink onClick={()=> setResponsiveMenu(!responsiveMenu)} className="link-style" to="/shopping_cart">
            <p>Cart</p>
          </NavLink>
        </div>
      }
